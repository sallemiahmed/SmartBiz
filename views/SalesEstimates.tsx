...
import { Search, Plus, Eye, Trash2, X, FileText, Printer, CheckCircle, ArrowRight } from 'lucide-react';
...
const SalesEstimates: React.FC<SalesEstimatesProps> = ({ onAddNew }) => {
  const { invoices, deleteInvoice, createSalesDocument, t, formatCurrency, settings } = useApp();
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg p-6">
            ...
            <div className="mt-6 flex flex-col gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="flex gap-3 mt-2">
                ...
                >
                    <CheckCircle className="w-4 h-4" /> {t('convert_to_invoice')}
                </button>
              </div>
            </div>
          </div>
