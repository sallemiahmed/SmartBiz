...
const SalesEstimates: React.FC<SalesEstimatesProps> = ({ onAddNew }) => {
  const { invoices, deleteInvoice, updateInvoice, createSalesDocument, clients, t, formatCurrency, settings } = useApp();
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
              ...
              {selectedDoc.status !== 'completed' && (
                <button
                  ...
                  className="flex-1 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors flex items-center justify-center gap-2"
                >
