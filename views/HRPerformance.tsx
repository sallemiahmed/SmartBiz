...
import { 
  Users, Star, BarChart3, Calendar, CheckCircle, XCircle, 
  Plus, Search, ChevronRight, Flag, MessageSquare, Award, TrendingUp
} from 'lucide-react';
...
// Internal Mock Data for standalone functionality
...
const HRPerformance: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'dashboard' | 'reviews' | 'cycles'>('dashboard');
  const [reviews, setReviews] = useState<PerformanceReview[]>(MOCK_REVIEWS);
  const [cycles, setCycles] = useState<ReviewCycle[]>(MOCK_CYCLES);
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
       <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center bg-gray-50 dark:bg-gray-900/50">
         ...
         <div className="flex gap-2">
           <input type="text" placeholder="Search employee..." className="px-3 py-1.5 text-sm border rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 dark:text-white focus:ring-2 focus:ring-indigo-500 outline-none" />
         </div>
       </div>
