  ...
  return (
    <>
      ...
      <aside className={sidebarClass}>
        <div className="flex items-center h-16 px-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center text-white font-bold">
              SB
            </div>
            <span className="text-lg font-bold text-gray-900 dark:text-white">SmartBiz</span>
          </div>
        </div>
                    ...
                    {item.subItems?.map((subItem, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="pl-2 rtl:pl-0 rtl:pr-2 text-left rtl:text-right w-full">
                            {t(subItem.labelKey)}
                          </span>
                          {subItem.hasAction && (
